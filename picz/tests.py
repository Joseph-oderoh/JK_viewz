...
from . models import Images,Locations,Categories
...
class ImagesTest(TestCase):
    ...
    def setUp(self):
        ...
        self.new_location = Locations(city='Kisumu', country='Kenya')
...
class LocationTest(TestCase):
    ...
    def test_update_category(self):
        ...
        '''
        update_cat = Categories.update_category('categoryA', 'differentCatg')
        self.assertEqual(update_cat.name, 'differentCatg')
